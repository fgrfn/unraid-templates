...
def generate_blank_template_card():
    ...
    return '''
      ...
      <div class="template-card">
        <div class="template-header">
          <div style="width: 36px; height: 36px; border-radius: 6px; margin-bottom: 10px; background: white; padding: 6px; box-shadow: 0 2px 8px rgba(0,0,0,0.12); display: flex; align-items: center; justify-content: center; font-size: 1.4em;">
            📝
          </div>
